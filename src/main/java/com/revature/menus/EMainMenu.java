...
public class EMainMenu extends AbstractMenu {
	...
	public List<MenuLine> buildMenu() {
		MenuLine l1 = new MenuLine(0, ()->"1: Access Customer Accounts", ()->{
			MenuSelector.getMenuSelector().updateNodeAfterCustomerId();
			MenuSelector.getMenuSelector().traverse(2);
		});
	MenuLine l2 = new MenuLine(1, ()->"2: Appove/Deny Pending Accounts", ()->{
			MenuSelector.getMenuSelector().traverse(0);
		});
	MenuLine l3 = new MenuLine(2, ()->"3: Transaction Log", ()->{
